...
export default function ChatWindow() {
  const {prompt,setPrompt,reply,setReply,setNewChat ,currThreadId,setPrevChats,theme,toggleTheme}=useContext(MyContext);
  ...
  const getReply=async()=>{
      ...
      try{
        ...
        const geminireply = await response.json();
